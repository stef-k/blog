<template>
    <div>
        ...
        <div v-if="loading" class="has-text-centered">
            <span class="underliner p-s">Loading projects, please wait...</span>
        </div>
  ...
  export default {
    ...
    methods: {
      loadPosts(page = '') {
        this.errors = [];
        this.loading = true;
        this.$http.get(window.myapp.url + '/api/admin/projects/' + page, {
          headers: {
      ...
      getEditUrl(id) {
        return window.myapp.url + '/admin/projects/' + id;
      },
      ...
      deletePost(id) {
        this.errors = [];
        this.$http.post(window.myapp.url + '/api/admin/projects/delete/', {id: id}, {
          headers: {
            Authorization: 'Bearer ' + myapp.token
          }
        }).then((response) => {
